...
```{r}
source("lib/plotDA_1.3.R") # plot LDA needs packages ggplot2, grid, ellipse and plyr
...
plotDA(discrimin = lda, fac = group, groupfac = NULL, scaling = 2, facname = "Sensibility", 
       groupfacname = "Group") + scale_shape_manual(values = c(21, 22, 23, 24), "Sensibility") + 
  theme_bw() +
  ggtitle("Uninfected LDA")
ggsave(filename = "images/LDA-detrended-uninfected-sensibilité.png", width = 6, 
       height = 6, dpi = 300)
...
plotDA(discrimin = lda, fac = group, groupfac = NULL, scaling = 2, facname = "Sensibility", 
       groupfacname = "Group") + scale_shape_manual(values = c(21, 22, 23, 24), "Sensibility") + 
  theme_bw() +
  ggtitle("Infected LDA")
ggsave(filename = "images/LDA-detrended-infected-sensibilité.png", width = 8, height = 8, 
       dpi = 300)
